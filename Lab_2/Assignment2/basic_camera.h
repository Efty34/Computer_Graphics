...
public:
    ...
    void ProcessKeyboard(Camera_Movement direction, float deltaTime) {
        ...
        if (direction == UP)       Position += Up * velocity;      // Assignment Req 3
        if (direction == DOWN)     Position -= Up * velocity;      // Assignment Req 3
    }
